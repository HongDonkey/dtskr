    ...
    <Box component="main" className="request-board-page">
      ...
      <Box className="request-board-shell">
        ...
        <Box component="section" className="request-board-panel">
          ...
          {!passwordChangeRequired && todayStatistics && <Box className="admin-statistics" aria-label={t('admin.todayStatistics')}><Box className="admin-statistic-item"><Typography component="span">{t('admin.todayVisitors')}</Typography><Typography component="strong">{todayStatistics.uniqueVisitors.toLocaleString()}</Typography></Box><Box className="admin-statistic-item"><Typography component="span">{t('admin.totalVisitors')}</Typography><Typography component="strong">{todayStatistics.totalVisitors.toLocaleString()}</Typography></Box><Typography component="small">{todayStatistics.date}</Typography></Box>}
